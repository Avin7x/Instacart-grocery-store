          ...
          <main className="flex-1">
            ...
            {loading ? (
              ...
              <div className="text-center py-16">
                ...
                <button
                  onClick={() => clearQueryParam()}
                  className="px-5 py-2 text-sm bg-app-green text-white rounded-xl hover:bg-app-green-light transition-colors"
                >
                  CLear Filters
                </button>
              </div>
