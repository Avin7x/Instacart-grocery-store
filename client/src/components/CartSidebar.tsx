...
import { ArrowRight, MinusIcon, PlusIcon, ShoppingBagIcon, Trash2Icon, XIcon } from "lucide-react";
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center justify-between mt-2">
                        <div className="flex items-center gap-1.5">
                          <button onClick={() => updateQuantity(item.product._id, item.quantity-1)} className="rounded-lg bg-white border border-app-border flex-center">
            ...
            {items.length > 0 && (
              <div className="p-5 border-t border-app-border space-y-3">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-medium">{deliveryFee === 0 ? <span className="text-app-success">Free</span> : `${deliveryFee.toFixed(2)}`}</span>
                </div>

                {deliveryFee > 0 && <p className="text-xs text-app-text text-center">Free delivery on orders over {currency}20!</p>}
