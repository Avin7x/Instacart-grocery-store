...
const AddressCard = ({
  ...
  return (
    <div
      key={addr.id}
      className="max-w-3xl bg-white rounded-2xl p-6 flex items-center justify-between"
    >
      {/* left */}
      ...
      <div className="flex items-center gap-1">
        ...
        <button
          onClick={() => handlDelete(addr.id)}
          className="p-2 text-app-text-light hover:text-app-error hover:bg-red0-50 rounded-lg transition-colors"
        >
