        ...
        <div className="p-3.5 text-zinc-700">
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-1 truncate">
                    ...
                    <span className="text-sx text-app-text-light block">{product.unit}</span>
                    {product.originalPrice > product.price && (
                        <span className="text-xs text-shadow-app-text-light line-through ml-1.5">{currency}{product.price.toFixed(1)}</span>
                    )}
                </div>
